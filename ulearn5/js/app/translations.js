...
GenwebApp.config(['$translateProvider', '$stateProvider', '$urlRouterProvider', '$locationProvider', function ($translateProvider, $stateProvider,$urlRouterProvider,$locationProvider) {
  ...
  $translateProvider.translations('en', {
    ...
    'ALLCOMMUNITIES_VIEW': {
      ...
      'FAVORITE': 'Favorite',
      'NOTNOTIFYPUSH': 'Notificació push',
      'SUBSCRIBE': 'Subscribe',
  ...
  $translateProvider.translations('es', {
    ...
    'ALLCOMMUNITIES_VIEW': {
      ...
      'FAVORITE': 'Favorito',
      'NOTNOTIFYPUSH': 'Notificación push',
      'SUBSCRIBE': 'Suscribir',
  ...
  $translateProvider.translations('ca', {
    ...
    'ALLCOMMUNITIES_VIEW': {
      ...
      'NOTNOTIFYPUSHERROR': 'Se ha producido un error al intentar activar o desactivar les notificacions push de la comunitat.',
