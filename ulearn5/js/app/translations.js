...
GenwebApp.config(['$translateProvider', '$stateProvider', '$urlRouterProvider', '$locationProvider', function ($translateProvider, $stateProvider,$urlRouterProvider,$locationProvider) {
    ...
    $stateProvider
            ...
            .state('search', {
              ...
              templateUrl: window.PORTAL_URL + '/++app++ulearn/templates/searchusers.html'
            })
            .state('allcommunities', {
              ...
              templateUrl: window.PORTAL_URL + '/++app++ulearn/templates/allcommunities.html'
            })
            .state('usercommunities', {
              ...
              templateUrl: window.PORTAL_URL + '/++app++ulearn/templates/usercommunities.html'
            })
  ...
  $translateProvider.translations('en', {
    ...
    'ALLCOMMUNITIES_VIEW': {
      ...
      'NOTNOTIFYPUSHERROR': 'There was an error while toogle notify push the community.',
      'NOTNOTIFYMAILERROR': 'There was an error while toogle notify mail the community.',
      ...
      'LINKINTEGRITYERROR': 'Unable to delete community because there is a link pointing to it in',
      'LINKINTEGRITYERROR2': ', you need to remove this link before you can delete it.',
      'FAVORITE': 'Favorite',
      'NOTNOTIFYPUSH': 'App',
      'NOTNOTIFYMAIL': 'Mail',
      'SUBSCRIBE': 'Subscribe',
  ...
  $translateProvider.translations('es', {
    ...
    'ALLCOMMUNITIES_VIEW': {
      ...
      'NOTNOTIFYPUSHERROR': 'Se ha producido un error al intentar activar o desactivar las notificaciones push de la comunidad.',
      'NOTNOTIFYMAILERROR': 'Se ha producido un error al intentar activar o desactivar las notificaciones al correo de la comunidad.',
      ...
      'LINKINTEGRITYERROR': 'No es posible eliminar la comunidad ya que hay un enlace apuntando a ésta en',
      'LINKINTEGRITYERROR2': ', hace falta quitar este enlace para poder eliminarla.',
      'FAVORITE': 'Favorito',
      'NOTNOTIFYPUSH': 'App',
      'NOTNOTIFYMAIL': 'Correo',
      'SUBSCRIBE': 'Suscribir',
  ...
  $translateProvider.translations('ca', {
    ...
    'ALLCOMMUNITIES_VIEW': {
      ...
      'NOTNOTIFYPUSHERROR': 'S\'ha produït un error al intentar activar o desactivar les notificacions push de la comunitat.',
      'NOTNOTIFYMAILERROR': 'S\'ha produït un error al intentar activar o desactivar les notificacions del correu de la comunitat.',
      'SUBSCRIBEERROR': 'S\'ha produït un error al intentar suscriure\'l a la comunitat.',
      ...
      'LINKINTEGRITYERROR': 'No és possible eliminar la comunitat, ja que hi ha un enllaç apuntant a aquesta en ',
      'LINKINTEGRITYERROR2': ', cal treure aquest enllaç per poder-ho eliminar.',
      'FAVORITE': 'Favorit',
      'NOTNOTIFYPUSH': 'App',
      'NOTNOTIFYMAIL': 'Correu',
      'SUBSCRIBE': 'Subscriu',
